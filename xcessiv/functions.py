...
def verify_main_dataset_extraction(path):
    """Verify main dataset function
    ...
    Args:
        path (string): Absolute file path of .py file containing extraction
            function named "extract_main_dataset"
    ...
    """
    X, y = import_object_from_path(path, "extract_main_dataset")()
...
if __name__ == '__main__':
    ...
    print(verify_main_dataset_extraction(filepath))
